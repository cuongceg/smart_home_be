...
const validateRegister = [
  body("gmail").isEmail().withMessage("Invalid email address").normalizeEmail(),
  body("password")
    .isLength({ min: 6 })
...
const validateForgotPassword = [
  body("gmail").isEmail().withMessage("Invalid email address"),
  checkValidation,
];
...
// validation rules for register fcm token
